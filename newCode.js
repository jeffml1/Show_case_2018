...
window.setInterval(function () {
    var tempJSON = 'application/1/node/2222222222222222/rx {"applicationID":"1","applicationName":"OPIoT-Testing","deviceName":"Gate-sensor","devEUI":"2222222222222222","txInfo":{"frequency":918000000,"dataRate":{"modulation":"LORA","bandwidth":125,"spreadFactor":8},"adr":false,"codeRate":"4/5"},"fCnt":11183,"fPort":1,"data":"UmVlZCBTd2l0Y2ggUmVhZGluZzowLjAwNDA3"}';
    tempJSON = tempJSON.substring(tempJSON.indexOf("{"));
    tempJSON = JSON.parse(tempJSON)
    var dataVal = tempJSON["data"]
